...
all:
	rm -f ./$(out_dir)/*.java
	cc -std=c++11 -c -I$(occ_headers) -o $(out_dir)/experiment-cc-code.so experiment-cc-code.cxx
	cd $(out_dir) && swig -I$(occ_headers) -outcurrentdir -c++ -java ../experiment-cc-code.i
	cc -std=c++11 -c -I. -I$(occ_headers) -I$(jni_headers) -I$(jni_darwin_headers) -o $(out_dir)/experiment-cc-code_wrap.so $(out_dir)/experiment-cc-code_wrap.cxx
